...
router.post('/accounts/deposit-amount', (req: Request, res: Response, next: NextFunction) =>
  accountController.depositAmount(req, res, next),
);
router.post('/accounts/withdraw-amount', (req: Request, res: Response, next: NextFunction) =>
